  ...
  return (
   <Container fluid className='py-5 bg-hl-primary'>
          <Row className="">
            ...
            <Col className="d-flex border border-dark border-2 mx-2 mb-5 mt-5" style={{borderRadius:"0.5rem", width:"13rem",}}>
              <Row className="justify-content-center bg-transparent w-100">
                ...
                <Row className="m-auto">
                  ...
                  <Col className='pl-5 ml-5'><h6 className="h8" style={{marginLeft:"4rem", marginRight:"-1rem"}}><AiFillHeart />92</h6></Col>
                </Row>
              </Row>
            </Col>
