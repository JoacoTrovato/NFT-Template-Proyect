...
const DashboardPage = () => {
  return (
    <Container fluid className='py-5 bg-hl-primary'>  
      
      <Row className="mt-5" style={{width:"100rem", marginLeft:"-5rem"}}>
        <Row>
          <Image src={profile_banner} alt="banner" />
        </Row>
      </Row>
      <Row className="mt-5 w-100">
        <Row className="w-25 m-auto p-auto align-items-center justify-content-center">
            <Image className='rounded-circle w-auto h-auto' src={profile_pic} alt="profile" />
            <h3 className='mt-5 ml-5 pl-5'>James Bond</h3>
        </Row>
      </Row>
